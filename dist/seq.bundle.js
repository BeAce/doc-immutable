...
var seq = (0, _immutable.Seq)(obj).map(function (x) {
  return x * x;
});

console.log(typeof seq === "undefined" ? "undefined" : (0, _typeof3.default)(seq));

console.log(seq.toObject());

console.time("oddSquares");
var oddSquares = (0, _immutable.Seq)([1, 2, 3, 4, 5, 6]).filter(function (x) {
  return x % 2;
}).map(function (x) {
  return x * x;
});
...
var oddArray = [1, 2, 3, 4, 5, 6].filter(function (x) {
  return x % 2;
}).map(function (x) {
  return x * x;
});
...
var map2seq = (0, _immutable.Map)({ a: 1, b: 2, c: 3 }).toSeq();
console.log(map2seq.flip().map(function (key) {
